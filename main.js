...
const starts = async (nathan = new WAConnection()) => {
    ...
    nathan.browserDescription = ['NathanBot','Chrome', '3.0']
    console.log(banner)
console.log(color('[•] [ BASE BY NATHAN ] [•]'))
console.log(color('Follow Me On Media Sosial'))
console.log(color(' ==============================================='))
console.log(color('│ ○ Youtube : https://youtube.com/c/ZEROBOT7                     '))
console.log(color('│ ○ Github : https://github.com/ZeroChanBot                       '))
console.log(color(' ==============================================='))
    nathan.on('qr', () => {
