...
//━━━━━━━━━━━━━━━[ DATE ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			nathan.sendMessage(from, teks, text, { thumbnail: gambar, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"Developer NathanBot",previewType:"PHOTO",thumbnail:gambar,sourceUrl:`https://chat.whatsapp.com/FTvfxlLed2XGhjjaKF67os`}}})
		}
		const reply2 = (teks) => {
